...
INSERT INTO Produits (nom, prix_unitaire, quantité_stock, id_categorie) VALUES
('F-16', 25.99, 50, 1),
('Boeing 747', 45.99, 30, 2),
('Rafale', 28.50, 40, 1);
...
INSERT INTO Lignes_Commande (id_commande, id_produit, id_quantite, prix_unitaire) VALUES
(1, 1, 2, 25.99),
(1, 3, 1, 28.50),
(2, 2, 1, 45.99);
